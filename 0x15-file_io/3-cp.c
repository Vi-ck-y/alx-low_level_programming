 ...
 * @file: This indicates the name of the file buffer is storing chars for.
 *
...
/**
 * main - Copy the elements of a file into another file.
 * @argc: The number of argument that is supplied to the program.
