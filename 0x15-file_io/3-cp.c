 ...
 * @file: Indicates the name of the file buffer is storing chars for.
 *
 ...
 * @fd: Indicates file descriptor to be closed.
 */
void close_file(int fd)
{
	int c;
...
/**
 * main - Copies the items in a file to another file.
 * @argc: The amount of arguments supplied to the program.
 * @argv: Indicates an  array of pointers to the arguments.
 *
 * Return: 0 on success.
 *
